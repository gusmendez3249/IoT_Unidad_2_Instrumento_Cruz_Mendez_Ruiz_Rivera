...
MQTT_USER = ""
MQTT_PASSWORD = ""
MQTT_CLIENT_ID = "ky033_linea"
MQTT_PORT = 1883
MQTT_TOPIC_PUB = "cm/trabajo/proximidad"

# Configuración KY-033
sensor = Pin(4, Pin.IN)  # Pin de entrada digital para el sensor
...
try:
    ...
    while True:
        # Leer estado del sensor (0 = línea detectada, 1 = sin línea)
        estado_actual = sensor.value()
        
        # Solo publicar si hay cambio de estado
        if estado_actual != estado_anterior:
            if estado_actual == 0:
                mensaje = "Linea detectada"
            else:
                mensaje = "Sin linea"
